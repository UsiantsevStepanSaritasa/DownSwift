...
class DownSwiftParseTests: XCTestCase {
    ...
    func testOnlyRegularArea() {
        ...
        XCTAssertEqual(string.symbols, rightExpression, "Tokenizing area with only regular style FAILED!")
    }
    ...
    func testOneBoldArea() {
        ...
        XCTAssertEqual(string.symbols, rightExpression, "Tokenizing one bold area FAILED!")
    }
    ...
    func testMultipleBoldAreas() {
        ...
        XCTAssertEqual(string.symbols, rightExpression, "Tokenizing multiple bold areas FAILED!")
    }
    ...
    func testOneItalicArea() {
        ...
        XCTAssertEqual(string.symbols, rightExpression, "Tokenizing one italic area FAILED!")
    }
    ...
    func testMultipleItalicAreas() {
        ...
        XCTAssertEqual(string.symbols, rightExpression, "Tokenizing multiple italic areas FAILED!")
    }
    ...
    func testOneStrikethroughArea() {
        ...
        XCTAssertEqual(string.symbols, rightExpression, "Tokenizing one strikethrough area FAILED!")
    }
    ...
    func testMultipleStrikethroughAreas() {
        ...
        XCTAssertEqual(string.symbols, rightExpression, "Tokenizing multiple strikethrough areas FAILED!")
    }
    ...
    func testAllStylesWithOneAreaForEach() {
        ...
        XCTAssertEqual(string.symbols, rightExpression, "Tokenizing all styles with one area for each FAILED!")
    }
    ...
    func testAllStylesWithMultipleAreas() {
        ...
        XCTAssertEqual(string.symbols, rightExpression, "Tokenizing all styles with multiple areas for each FAILED!")
    }
}
